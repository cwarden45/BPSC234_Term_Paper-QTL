...
**It is reassuring that the heritability estimates for the *random trait* are low or zero** - if you could achive a higher heritability estimate, then I might be concerned with estimates ~0.5 for some of the crosses above.
