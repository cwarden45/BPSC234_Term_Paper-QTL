...
Both the [lesson](https://smcclatchy.github.io/mapping/05-perform-genome-scan/) on *"Performing a genome scan"* and the [documentation](https://search.r-project.org/CRAN/refmans/qtl2/html/scan1.html)* for `scan1()` reference [Haley and Knott 1992](https://pubmed.ncbi.nlm.nih.gov/16718932/) for *"Haley-Knott regression"*.
