...
output.plot1 = "MaizeMAGIC_Demo-HeightOnly-HK_LOD.png"
...
output.plot2 = "MaizeMAGIC_Demo-HeightOnly-LMM_LOD.png"
...
#add some plotting and output tables, based upon https://github.com/cwarden45/BPSC234_Term_Paper-QTL/blob/main/run_R_qtl2-Lactate-Model1.R
output.plot3 = "MaizeMAGIC_Demo-HeightOnly-LMM.LOCO_LOD.png"
...
output.plotC = "MaizeMAGIC_Demo-HeightOnly-Combined_LOD.png"
png(output.plotC, type="cairo")
color = c("slateblue", "violetred", "green3")
par(mar=c(4.1, 4.1, 1.6, 1.1))
ymx = max(maxlod(out_hk), maxlod(out_lmm), maxlod(out_loco))
    plot(out_hk, pmap, lodcolumn=1, col=color[1], main=colnames(maize$pheno),
              ylim=c(0, ymx*1.02))
