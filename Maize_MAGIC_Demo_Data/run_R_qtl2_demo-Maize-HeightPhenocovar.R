...
output.file1 = "MaizeMAGIC_Demo-HeightPhenocovar-HK_LODpermutations.txt"
...
output.file2 = "MaizeMAGIC_Demo-HeightPhenocovar-HK_ParentalProb-PH.txt"
...
fit1_sample_stats = data.frame(sample=names(fl_fit1$ind_lod),
								...
								resid=fl_fit1$resid)
output.file3 = "MaizeMAGIC_Demo-HeightPhenocovar-HK_sample_stats-PH.txt"
...
fit1_parental_stats = data.frame(parental=names(fl_fit1$coef),
								...
								blup.SE=fl_blup$SE)
output.file4 = "MaizeMAGIC_Demo-HeightPhenocovar-HK_parental_stats-PH.txt"
