...
output.file1 = "ArabidopsisMAGIC_Demo-HeightOnly-HK_LODpermutations.txt"
...
output.file2 = "ArabidopsisMAGIC_Demo-HeightOnly-HK_ParentalProb.txt"
...
output.file3 = "ArabidopsisMAGIC_Demo-HeightOnly-HK_peak.txt"
...
fit1_sample_stats = data.frame(sample=names(fl_fit1$ind_lod),
								...
								resid=fl_fit1$resid)
output.file3 = "ArabidopsisMAGIC_Demo-HeightOnly-HK_sample_stats.txt"
...
fit1_parental_stats = data.frame(parental=names(fl_fit1$coef),
								...
								blup.SE=fl_blup$SE)
output.file4 = "ArabidopsisMAGIC_Demo-HeightOnly-HK_parental_stats.txt"
